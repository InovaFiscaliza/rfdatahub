...
class Smp(Mosaico):
    ...
    def validate_channels(
        ...
        grouped_channels[["Blocos_Downlink", "Faixas", "Canalização"]] = (
            grouped_channels[["Blocos_Downlink", "Faixas", "Canalização"]].astype(
                "string", copy=False
            )
        )
        grouped_channels["Offset"] = grouped_channels["Offset"].astype(
            "float", copy=False
        )
