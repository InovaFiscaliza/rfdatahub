...
Docs: https://InovaFiscaliza.github.io/rfdatahub/estacoes.html.md"""
...
# %% ../nbs/04_estacoes.ipynb #6f30e409
import pandas as pd
from dotenv import find_dotenv, load_dotenv
from fastcore.foundation import L
from fastcore.parallel import parallel

from .constants import COLS_SRD
from .location import Geography
...
# %% ../nbs/04_estacoes.ipynb #1c8e836b
load_dotenv(find_dotenv(), override=True)
pd.options.mode.copy_on_write = True

# %% ../nbs/04_estacoes.ipynb #06d77f5e
class Estacoes(Base):
